...
public class AusgabeBasisConnection implements Connection {
    ...
    public Statement createStatement() throws SQLException {
        return new AusgabeStatement(this, repository);
    }
    ...
    public CallableStatement prepareCall(String sql, int resultSetType,
            int resultSetConcurrency, int resultSetHoldability)
            throws SQLException {
        return new AusgabeCallableStatement(this, repository,  sql);
    }
    ...
    public PreparedStatement prepareStatement(String sql, int resultSetType,
            int resultSetConcurrency, int resultSetHoldability)
            throws SQLException {
        return new AusgabePreparedStatement(this, repository,  sql);
