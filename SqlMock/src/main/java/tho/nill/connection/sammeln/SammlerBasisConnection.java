...
public class SammlerBasisConnection implements Connection {
    private static final Logger LOG = Logger.getLogger(SammlerBasisConnection.class);
    ...
    public SammlerBasisConnection(Connection con, AbfrageRepository repository,AbfrageUmgebung umgebung) {
        super();
        this.con = con;
    ...
    public Statement createStatement() throws SQLException {
        ...
        return new SammlerStatement(stmt, repository);
    }
    ...
    public CallableStatement prepareCall(String sql, int resultSetType,
        ...
        CallableStatement stmt = con.prepareCall(sql, resultSetType, resultSetConcurrency,
                resultSetHoldability);
        return new SammlerCallableStatement(stmt, repository);
    }
    ...
    public PreparedStatement prepareStatement(String sql, int resultSetType,
        ...
        PreparedStatement stmt = con.prepareStatement(sql, resultSetType, resultSetConcurrency,
                resultSetHoldability);
        return new SammlerPreparedStatement(stmt, repository);
